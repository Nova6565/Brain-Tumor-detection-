 ...
 * Generated at: 2024-05-18 12:42:47 UTC
...
public final class Register_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("<!-- \r\n");
      out.write("create a bean (object) for both the database and user \r\n");
      out.write("classes with \r\n");
      out.write("the appropriate scopes and parameters,  \r\n");
      out.write("then call the appropriate method in the database\r\n");
      out.write("\r\n");
      out.write("if the user is added successfully, show the Welcome.jsp page,\r\n");
      out.write("otherwise, return to the Register.jsp with an error message\r\n");
      out.write("-->\r\n");
      out.write("	\r\n");
      out.write("\r\n");
      ...
      out.write('\r');
      out.write('\n');
      advanced.User u = null;
      u = (advanced.User) _jspx_page_context.getAttribute("u", jakarta.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (u == null){
        u = new advanced.User();
        _jspx_page_context.setAttribute("u", u, jakarta.servlet.jsp.PageContext.REQUEST_SCOPE);
        out.write('\r');
        out.write('\n');
	...
	u.setDate(request.getParameter("birthdate"));
		if(db.emailFound(u.getEmail())){
			out.print("<p class = 'error-msg'>Already has an account</p>");
			request.getRequestDispatcher("Index.jsp").include(request, response);
			
		}
		else{
			if(db.InsertUser(u)==1){

				request.getRequestDispatcher("Index.jsp").include(request, response);
				out.print("<p class = 'success-msg'>Registeration succesfull</p>");
			}
