 ...
 * Generated at: 2024-05-15 19:37:56 UTC
...
public final class editController_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
	...
	db.deleteIng(r.getId());
	ArrayList<Ingredients> i=new ArrayList<Ingredients>();
	for(String e:ingredients){
		if(db.isInfFound(e)!=null){
			i.add(db.isInfFound(e));
			db.recipeIng(r,e.toLowerCase());
		}
	}
	r.setIngredients(i);
	r.calcCalories();
	if(db.editRecipe(r)==1){
		out.print("<p class='success-msg'>Edited succesfully</p>");
		request.getRequestDispatcher("YourKitcchen.jsp").include(request, response);
	}
