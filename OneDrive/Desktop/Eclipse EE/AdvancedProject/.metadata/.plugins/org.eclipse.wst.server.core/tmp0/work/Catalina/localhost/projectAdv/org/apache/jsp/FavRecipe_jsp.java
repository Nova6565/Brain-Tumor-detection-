 ...
 * Generated at: 2024-05-15 22:31:18 UTC
...
public final class FavRecipe_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    position: absolute; /* Position can be adjusted to absolute if needed *//* Adjust this value based on your layout */\r\n");
      out.write("    left: 50%;\r\n");
      ...
      out.write("    border-radius: 5px;\r\n");
      out.write("    margin: 10px 0;\r\n");
      out.write("    margin-top: 0.007%;\r\n");
      out.write("    position: absolute; /* Position can be adjusted to absolute if needed */\r\n");
      out.write("    position: fixed;\r\n");
      out.write("top: 0px; /* Adjust this value based on your layout */\r\n");
      out.write("    left: 50%;\r\n");
      out.write("    transform: translateX(-50%); /* Centers the message */\r\n");
      out.write("    width: 20%; /* Or adjust as needed */\r\n");
      out.write("    box-sizing: border-box; /* Includes padding and border in width */\r\n");
	...
	int x=Integer.parseInt(request.getParameter("recipeID"));
	if(db.isFavfound((User)session.getAttribute("u"), x)!=1){
		int i=db.insertFav((User)session.getAttribute("u"), x);
		if(i==1){
			out.print("<p class = 'success-msg'>Added succesfully</p>");
			 request.getRequestDispatcher("Fav.jsp").include(request, response);
		}
	}
	else{
		out.print("<p class = 'error-msg'>Already added</p>");
		 request.getRequestDispatcher("Fav.jsp").include(request, response);
	}
